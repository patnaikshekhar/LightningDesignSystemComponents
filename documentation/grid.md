...
This is the basic LDS Grid component. It is used in conjunction with a [ldsc:col](col.md) component.

## Attributes
- wrap (Boolean) - Should the grid wrap. Default is true.
- horizontal (String) - The horizontal alignment. Can be blank, center, space, spread, end
- vertical (String) -	The vertical alignment. Can be blank, center, end or stretch
